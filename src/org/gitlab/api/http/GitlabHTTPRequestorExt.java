...
import org.gitlab.api.GitlabAPIExt;
 ...
 * @author &#064;timols (Tim O)
 */
public class GitlabHTTPRequestorExt {

    private static final Pattern PAGE_PATTERN = Pattern.compile("([&|?])page=(\\d+)");

    private final GitlabAPIExt root;
    ...
    public GitlabHTTPRequestorExt(GitlabAPIExt root) {
        this.root = root;
    }
     ...
     * @return this
     */
    public GitlabHTTPRequestorExt authenticate(String token, TokenType type, AuthMethod method) {
        this.apiToken = token;
        this.tokenType = type;
     ...
     * @return this
     */
    public GitlabHTTPRequestorExt method(String method) {
        try {
     ...
     * @return this
     */
    public GitlabHTTPRequestorExt with(String key, Object value) {
    ...
    private void submitData(HttpURLConnection connection) throws IOException {
        ...
        GitlabAPIExt.MAPPER.writeValue(connection.getOutputStream(), data);
    }
    ...
    private <T> T parse(HttpURLConnection connection, Class<T> type, T instance) throws IOException {
        ...
        try {
            ...
            if (type != null) {
                return GitlabAPIExt.MAPPER.readValue(data, type);
            } else if (instance != null) {
                return GitlabAPIExt.MAPPER.readerForUpdating(instance).readValue(data);
            } else {
                return null;
            }
